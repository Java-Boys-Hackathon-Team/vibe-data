...
public final class PromptTemplates {
    ...
    public static final String RULES = """
            ...
            - Предпочитайте: партиционирование, ordering, z-ordering, исправление типов данных, устранение лишних колонок, predicate pushdown, join reordering, денормализацию при наличии звёздной/снежинки схемы.
            ...
            - Сохраняйте исходный taskId у переписанных запросов.
    ...
    public static final String QUERY_OPTIMIZATION_PROMPT = """
            ...
            - Инструменты для выполнения EXPLAIN-анализа (для их вызова нужно передавать taskid и queryid, а не сам запрос).
